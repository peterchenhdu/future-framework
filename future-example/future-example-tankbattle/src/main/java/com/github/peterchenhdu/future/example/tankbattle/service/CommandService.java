...
import com.github.peterchenhdu.future.example.tankbattle.resource.map.xml.parse.MapParser;
import com.github.peterchenhdu.future.util.ReflectUtils;
...
public class CommandService {
    ...
    public void executeByCmd(String cmd) {
        ReflectUtils.executeByMethodName(this, cmd, null, null);
    }

    public void executeCustomMapMenu(String para) {
        ReflectUtils.executeByMethodName(this, "loadCustomMap", new Class[]{String.class}, new String[]{para});
    }
