...
package com.github.peterchenhdu.future.tool.mb.plugin;

import com.github.peterchenhdu.future.tool.mb.generator.FutureMapperCommentGenerator;
 ...
 */
public class FutureMapperPlugin extends FalseMethodPlugin {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        interfaze.addJavaDocLine(" * " + introspectedTable.getRemarks() + " - Mapper接口");
        interfaze.addJavaDocLine(" * @author " + systemProperties.getProperty("user.name"));
    ...
    public void setContext(Context context) {
        ...
        if (useMapperCommentGenerator) {
            ...
            commentCfg.setConfigurationType(FutureMapperCommentGenerator.class.getCanonicalName());
        ...
        Assert.notNull(classUrl, " URL is null");
        String classPath = classUrl.getPath();
        String baseProjectPath = classPath.substring(0, classPath.lastIndexOf("target"));
        context.getSqlMapGeneratorConfiguration().setTargetProject(baseProjectPath +
                context.getSqlMapGeneratorConfiguration().getTargetProject());
        context.getJavaModelGeneratorConfiguration().setTargetProject(baseProjectPath +
                context.getJavaModelGeneratorConfiguration().getTargetProject());
        context.getJavaClientGeneratorConfiguration().setTargetProject(baseProjectPath +
