...
import com.github.peterchenhdu.future.tool.crawler4j.service.news.impl.NewsServiceImpl;
...
//        "http://news.163.com/special/"
    ...
    private INewsService newsService = SpringContextUtils.getBean("newsServiceImpl", NewsServiceImpl.class);
    ;
    ...
    public void visit(Page page) {
        ...
        //自定义过滤规则，根据网站编写
        if (url.length() < 30 || !url.startsWith("http://news.163.com/")
                || !Character.isDigit(url.charAt(20))
                || !Character.isDigit(url.charAt(21))
                || !Character.isDigit(url.charAt(23))
                || !Character.isDigit(url.charAt(24))
                || !Character.isDigit(url.charAt(25))
                || !Character.isDigit(url.charAt(26))
                || !Character.isDigit(url.charAt(28))
                || !Character.isDigit(url.charAt(29))) {
